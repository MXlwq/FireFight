...
public class FireFighting extends JFrame {
	...
	private JToolBar createToolBar() { // 创建工具栏的方法
		...
		//ImageIcon icon=new ImageIcon(FireFighting.class.getResource("/solutionAddtb.png"));//添加菜单栏图标	
		ImageIcon icon=new ImageIcon(FireFighting.class.getResource("/solutionAddtb.png"));//添加菜单栏图标	
		...
		//在工具栏添加火灾级别规则修改按钮
				JButton FiretypeModiAndDelButton=new JButton(MenuActions.FIRETYPE_MODIFY);
				ImageIcon FiretypeModiAndDelicon=CreatecdIcon.add("firetypeModiAndDeltb.png");//创建图标方法
		...
		//在工具栏添加火灾级别规则修改按钮
		JButton FirelevelModiAndDelButton=new JButton(MenuActions.FIRELEVEL_MODIFY);
		ImageIcon FirelevelModiAndDelicon=CreatecdIcon.add("firelevelModiAndDeltb.png");//创建图标方法
