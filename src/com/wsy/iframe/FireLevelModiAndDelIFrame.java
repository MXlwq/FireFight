...
public class FireLevelModiAndDelIFrame extends JInternalFrame {
	...
	//nady 20141014
	//private String[] columnNames={ "燃烧面积", "燃烧容积", "呼叫次数", "燃烧物","被困人数", "火灾级别"};
...
//nady 20141014			
			//int i=Dao.UpdateReader(id,readername.getText().trim(), age.getText().trim(), zy.getText().trim(),zj,zjnumber.getText().trim(),maxnumber.getText().trim());
