...
import com.wsy.iframe.FireLevelModiAndDelIFrame.TableListener;
...
public class FireTypeAddIFrame extends JInternalFrame {
	...
	String [] array;
	//private String[] columnNames={ "火灾类别编号","燃烧物编号（前件）", "燃烧物（前件）","火灾类别（后件）", "频率", "可信度"};
	...
	public FireTypeAddIFrame() {
      ...
      //需要加载到JTable的容器
		...
		label_3.setText("     燃烧物(前件)：");
		label_3 .setHorizontalAlignment(SwingConstants.LEFT);
		label_3 .setPreferredSize(new Dimension(0, 0));
		label_3 .setMinimumSize(new Dimension(0, 0));
		panel_2.add(label_3);
		
		RSW = new JTextField(20);
		RSW.setPreferredSize(new Dimension(0, 0));
		panel_2.add(RSW);
		...
		*/
		...
		choice3=new JComboBox();
         ...
         String[] array2={"一般建筑火灾","高层建筑火灾","地下空间火灾","油类火灾","一般气体火灾","有毒气体火灾","露天火灾","油气储罐火灾","交通工具火灾","一般性火灾"};//,"地下室空间火灾"
		...
		label_18 .setPreferredSize(new Dimension(0, 0));
		label_18 .setMinimumSize(new Dimension(0, 0));
		label_18.setText("  ");
		...
		//panel_5.setBorder(new LineBorder(SystemColor.activeCaptionBorder, 1, false));
		...
		button.addActionListener(new ActionListener(){
			public void actionPerformed(final ActionEvent e) {
				...
				//0711
				/*//int i=Dao.InsertFireType(GZBH2, HZLB,fre,con);
				if(i==1){
