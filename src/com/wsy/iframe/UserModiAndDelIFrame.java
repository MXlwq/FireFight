...
public class UserModiAndDelIFrame extends JInternalFrame {
	...
	private String[] columnNames1 = { "编号", "条件1", "描述", "条件2", "描述", "频率",
			"可信度" };
	private String[] columnNames2 = { "编号", "结论1", "描述", "结论2", "描述", "频率",
			"可信度" };
	...
	public UserModiAndDelIFrame() {
		 ...
		 * gridLayout.setVgap(9); gridLayout.setHgap(5);
		 * panel_2.setLayout(gridLayout); panel_2.setPreferredSize(new
		 * Dimension(0,80)); panel_1.add(panel_2, BorderLayout.SOUTH);
		 */
		 ...
		 * gridLayout2.setVgap(9); gridLayout2.setHgap(5);
		 * panel_3.setLayout(gridLayout2); panel_3.setPreferredSize(new
		 * Dimension(0,80)); panel_1.add(panel_3, BorderLayout.SOUTH);
		 */
