...
public class FireLevelAddIFrame extends JInternalFrame {
	...
	String [] array;
	private String[] columnNames={"级别编号","级别名称", "频率", "可信度","燃烧面积编号", "燃烧容积编号", "呼叫次数编号", "所处阶段编号", "火势编号","蔓延速度编号","被困人数编号", "重伤人数编号", "死亡人数编号", "突变险情编号"};
	...
	/////////////////////////////////////////////////////////////////////////////////////	
		...
		array=new String[]{"1.0","0.9","0.8","0.7","0.6","0.5","0.4","0.3","0.2","0.1","0.0"};
...
panel_2.add(comboBox);
				...
				panel_2.add(label_12);
						...
						comboBox.setModel(new DefaultComboBoxModel(array));
						panel_2.add(comboBox);
				array=new String[]{"1.0---非常确定","0.9---确定","0.8---比较确定","0.7","0.6","0.5","0.4","0.3","0.2","0.1","0.0"};
				for(int i=1;i<array.length;i++){
					comboBox.setSelectedIndex(i);
					comboBox.setSelectedItem(array);
				}
	...
	class TableListener extends MouseAdapter {
		public void mouseClicked(final MouseEvent e) {
			...
			TLB.setText(table.getValueAt(selRow, 3).toString().trim());*/
	...
	class ButtonAddListener implements ActionListener {
		...
		public void actionPerformed(final ActionEvent e) {
			...
			//int i=Dao.InsertReader(readername.getText().trim(), 
					///TMJ.getText().trim(),jibie.getText().trim(),zj,zjnumber.getText().trim(), maxnumber.getText().trim());
