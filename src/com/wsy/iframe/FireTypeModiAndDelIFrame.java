...
//		panel_1.add(scrollPane);
	   ...
	   // RuleId.setFocusable(false);
		...
		//String[] array={"图书名称","图书作者"};
         String[] array2={"一般建筑火灾","高层建筑火灾","地下空间火灾","油类火灾","一般气体火灾","一般气体火灾","有毒气体火灾","露天火灾","油气储罐火灾","交通工具火灾","一般性火灾"};//,"地下室空间火灾"
		...
		/*choice=new JComboBox();
		//String[] array={"图书名称","图书作者"};
         String[] array1={"砖木结构或闷顶结构或居民住宅或仓库","高于二十四米的建筑物","地铁或隧道或地下商场","石油化工单位或储油罐或油类运输工具","天然气输送管道或存气罐或气体运输工具","特殊气体单位","粮食残酷或木材场或稻草场","火车或船舶或飞机或汽车","电器或单体汽车或垃圾"};//,"地下室空间火灾"
		for(int i=0;i<array1.length;i++){
			choice.addItem(array1[i]);*/
	...
	class ButtonAddListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			//int i=Dao.UpdatebookType(RuleId.getText().trim(),selectedItem.toString(), days.getText().trim());//,fk.getText().trim());
